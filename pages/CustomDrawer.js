  ...
  return (
    <View style={styles.Outercontainer}>
      <View style={styles.container}>
        <TouchableOpacity onPress={() => navigation.navigate("Poll")} style={styles.touchOp}>
            <Icon name="list" size={30} color="#fff"></Icon>
            <Text style={styles.txtStyle} >Polls</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate("Createpoll")} style={styles.touchOp}>
            <Icon name="user-plus" size={30} color="#fff"></Icon>
            <Text style={styles.txtStyle} >CreatePoll</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate("Userlist")} style={styles.touchOp}>
